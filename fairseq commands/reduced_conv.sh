...
fairseq-generate data-bin/europarl-v7.fr-en.reduced_conv --path data-bin/wmt14.en-fr.fconv-py/model.pt --beam 3 --batch-size 32 --source-lang en --target-lang fr --gen-subset test --tokenizer moses --bpe subword_nmt --bpe-codes data-bin/wmt14.en-fr.fconv-py/bpecodes > data-bin/out_reduced_conv.txt
